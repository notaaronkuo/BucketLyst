...
import { TopbarLanding } from "./Bars/topbar";
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <p className="hook-description">
            Stay organized, never forget your favorite spots by creating your
        ...
        <div class="col-md-6">
          ...
          <p className="small-text-below-2">
            You can easily pin your favorite spots on your personal map and
            create custom lists, so you'll never forget the restaurant you
            discovered or the new park you visited. Whether you're tracking the
            places you've been, the ones you want to go, or the ones your loved
            ones recommended, Bucketlys has got you covered!
          </p>
        </div>
        <div class="col-md-6">
          <img
        ...
        <div class="col-md-6">
          ...
          <p className="small-text-below-3">
            ...
            favorite places to find the perfect spot for your mood, whether
            you're looking for a cozy coffee shop or a lively bar. With
            categories like "food," "entertainment," and "outdoor activities,"
            and filters like "open now" and "places near you," Bucketlys makes
            it easy to discover new places and revisit your old favorites. With
            Bucketlys, your perfect spot is just a few clicks away!
          </p>
        </div>
        ...
        <div class="col-md-6">
          ...
          <p className="small-text-below-4">
            Next time your friends ask you for a sushi restaurant
            recommendation, simply pull up your custom list and find the perfect
            spot with ease. Bucketlys makes it easy to share your favorite
            places with your friends and family, so you'll never have to
            scramble to remember where you went or what you liked about a
            particular spot. With Bucketlys, all your favorite spots are just a
            click away!
          </p>
        </div>
        <div class="col-md-6">
