...
if (sessionStorage.getItem('isFunctionCalled') === null) {
  sessionStorage.setItem('isFunctionCalled', 'false');
  console.log('isFunctionCaleld: ', sessionStorage.getItem('isFunctionCalled'));
}
...
const LoggedInPaths = ['/home', '/location', '/soonPage', '/users', '/yourlist', '/userpage', '/userpage/:id','/userpage/:id/*', '/editprofile', '/settings', '/eachlist', '/eachlist/:id/*', '/tasks', '/createdlist', '/editlist', '/makelist', '/viewlist', '/successlist', '/ownlist', '/listdiscover', '/listsaved', '/listfollow', '/tempfooter', '/implementlater'];
      ...
      {isLoggedIn && <BucketLyst setIsLoggedIn={setIsLoggedIn}/>}
          ...
          />
            ...
            <Route path="/yourlist" element={<YourLists navigateTo={navigateTo} />} />
              ...
              <Route path="/userpage/:id" element={<UserPage navigateTo={navigateTo} />} />
              <Route path="/userpage" element={<UserPage2 navigateTo={navigateTo} />} />
              
              <Route path="/eachlist" element={<EachList navigateTo={navigateTo} />} />
              <Route path="/eachlist/:id" element={<EachList navigateTo={navigateTo} />} />
