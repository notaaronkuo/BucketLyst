...
function TermsService() {
  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to BucketLyst, 1 Cupertino, CA 95014.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to BucketLyst, accessible from{" "}
            <a
              href="http://www.TEMPBUCKETLYSTNAME.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://www.TEMPBUCKETLYSTNAME.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: kpcrocks@gmail.com</li>
      </ul>
    </div>
  );
}
