    ...
    <div className="list-item">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-description">{subtitle}</p>
          <p class="card-more-description">{tags.join(" ")}</p>
          <div class="footer-text">{user}</div>
        </div>
      </div>
...
function OtherListHolder({ map }) {
  const listings = [];

  for (const [id, values] of Object.entries(map)) {
    listings.push(<ListItemsOthers key={id} {...values} />);
  }
      ...
      <div className="home-vertical-holder">
        ...
        <div className="home-middle">
          ...
          {location.pathname === "/listfollow" ? (
            <OtherListHolder map={DummyData2} />
          ) : (
            ""
          )}
          {location.pathname === "/listdiscover" ? (
            <OtherListHolder map={DummyData3} />
          ) : (
            ""
          )}
          {location.pathname === "/listsaved" ? (
            <OtherListHolder map={DummyData4} />
          ) : (
            ""
          )}
        </div>
