      ...
      return (
        <div className="n-user-item">
          <div className="n-user-item-l">
              <img src={user.pfp} alt="Profile" className="n-user-img" />
              
          </div>
          <div className="n-user-item-r">

          <div className="n-user-name">Ari has requested to follow you</div>
      ...
      >
        {isFollowing === 'reject' ? "Rejected" : "Reject"}
            ...
            <div className = "n-time">
                {formatCreationTime(notification.creation_time)}
            </div>
          </div>
        </div>
      );
